...
@.wordIndexGlobal = internal constant [3 x i32] [i32 0, i32 1, i32 2], align 4
@.wordIndexGlobal.1 = internal constant [2 x i32] [i32 3, i32 2], align 4
@.wordIndexGlobal.2 = internal constant [3 x i32] [i32 0, i32 1, i32 4], align 4
@.compStr = private constant [10 x i8] c"Anonymous\00", align 1
@.compStr.3 = private constant [7 x i8] c"String\00", align 1
@.compStr.4 = private constant [2 x i8] c"1\00", align 1
@.compStr.5 = private constant [5 x i8] c"Test\00", align 1
@.compStr.6 = private constant [2 x i8] c"2\00", align 1
@lookup_table_compressed = constant [5 x i8*] [i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.compStr, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.compStr.3, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.compStr.4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.compStr.5, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.compStr.6, i32 0, i32 0)], align 4
...
entry:
  %strHolder1 = alloca [6 x i8]
  %arrayRef2 = getelementptr [6 x i8], [6 x i8]* %strHolder1, i32 0, i32 0, !dbg !33
  call void @tableLookupSpace(i8* %arrayRef2, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @.wordIndexGlobal.1, i32 0, i32 0), i32 2), !dbg !33
  %strHolder = alloca [18 x i8]
  %arrayRef = getelementptr [18 x i8], [18 x i8]* %strHolder, i32 0, i32 0, !dbg !33
  call void @tableLookupSpace(i8* %arrayRef, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @.wordIndexGlobal, i32 0, i32 0), i32 3), !dbg !33
  call void @printStuff(i8* %arrayRef) #4, !dbg !33
  call void @printStuff(i8* %arrayRef2) #4, !dbg !34
  ret void, !dbg !35
}
...
entry:
  %strHolder = alloca [18 x i8]
  %arrayRef = getelementptr [18 x i8], [18 x i8]* %strHolder, i32 0, i32 0, !dbg !57
  call void @tableLookupSpace(i8* %arrayRef, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @.wordIndexGlobal.2, i32 0, i32 0), i32 3), !dbg !57
  call void @printStuff(i8* %arrayRef) #4, !dbg !57
  ret void, !dbg !58
}
