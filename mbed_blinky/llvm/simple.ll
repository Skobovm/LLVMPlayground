...
@.str.2 = private unnamed_addr constant [19 x i8] c"Anonymous String 2\00", align 1
...
entry:
  call void @printStuff(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0)) #3, !dbg !40
  ret void, !dbg !41
}
...
entry:
  call void @printStuff(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0)) #3, !dbg !63
  ret void, !dbg !64
}
